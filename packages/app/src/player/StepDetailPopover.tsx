...
export const StepDetailPopover = ({
  ...
  >
    ...
    <div className="overflow-hidden rounded-2xl bg-white shadow-[0_22px_48px_-14px_rgba(15,23,42,0.28)] ring-1 ring-slate-900/[0.07]">
      <div className="h-1 bg-gradient-to-r from-blue-600 via-indigo-500 to-sky-400" aria-hidden />

      <div className="px-5 pb-5 pt-4">
        <div className="flex items-start gap-3.5">
          <div
            className="flex h-10 w-10 shrink-0 flex-col items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white shadow-md shadow-blue-600/25"
            aria-hidden
          >
            <span className="text-[9px] font-medium uppercase leading-none tracking-widest opacity-80">
              Step
            </span>
            <span className="mt-0.5 text-sm font-bold leading-none tabular-nums">{stepNumber}</span>
          </div>
        ...
        {description ? (
          <div className="mt-4 rounded-xl border border-slate-100 bg-slate-50/80 px-4 py-3">
            <p className="text-[11px] font-medium uppercase tracking-wide text-slate-400">Details</p>
