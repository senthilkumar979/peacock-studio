...
interface PeacockEmbedWatermarkProps {
  /** Org plan; paid plans (pro/team) hide the watermark. Defaults to free. */
  plan?: string | null;
}
 ...
 */
export const PeacockEmbedWatermark = ({ plan }: PeacockEmbedWatermarkProps) => {
