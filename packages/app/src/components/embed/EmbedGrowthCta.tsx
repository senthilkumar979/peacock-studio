 ...
 */
export const EmbedGrowthCta = ({ compact = false }: EmbedGrowthCtaProps) => (
  <aside
  ...
  >
    ...
    <h3 className={`font-bold tracking-tight text-slate-900 ${compact ? 'mt-1 text-base' : 'mt-2 text-lg'}`}>
      Would you like to create a flow doc like this?
    </h3>
    <p className="mt-2 text-sm leading-relaxed text-slate-600">
      Capture clicks, branch decisions, and screenshots into interactive guides your team
      can share, embed, and keep up to date — without rewriting docs by hand.
    </p>
