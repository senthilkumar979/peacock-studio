      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/" className="inline-flex items-center gap-2.5 rounded-lg outline-none ring-peacock-500 focus-visible:ring-2">
            ...
            <Link
              to={DASHBOARD_PATH}
              className="mt-4 inline-flex rounded-xl bg-peacock-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-peacock-700"
            >
              Open app
            </Link>
          </div>
