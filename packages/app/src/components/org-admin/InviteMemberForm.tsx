...
export const InviteMemberForm = ({ busy, onInvite }: InviteMemberFormProps) => {
  ...
  return (
    <form
      onSubmit={(event) => {
        ...
        void (async () => {
          await onInvite({ email, role, capabilities });
          setEmail('');
          setRole('member');
        })();
      }}
        ...
        <div className="flex items-start gap-3 text-white">
          ...
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-peacock-100/90">
              Send a secure invitation that expires in 7 days. Set their role and permissions before
              they join.
            </p>
          </div>
        </div>
