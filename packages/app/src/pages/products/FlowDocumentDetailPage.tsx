...
import { FLOW_DOCUMENT_CAPABILITY_GROUPS } from './flowDocumentsData';
import { FlowDocumentCapabilityGroupSection } from './FlowDocumentCapabilityGroupSection';
      ...
      <div className="landing-section-inner">
        ...
        <div className="mt-10 space-y-8">
          {FLOW_DOCUMENT_CAPABILITY_GROUPS.map((group, index) => {
            ...
            return (
              <FlowDocumentCapabilityGroupSection
                key={group.id}
                group={group}
                groupIndex={index}
