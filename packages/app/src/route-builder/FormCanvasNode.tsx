...
import type { FormCanvasNodeData } from '@/route-builder/routeCanvasMapper';

type FormFlowNode = Node<FormCanvasNodeData, 'form'>;

export const FormCanvasNode = ({ data }: NodeProps<FormFlowNode>) => (
  <div className="relative">
    ...
    >
      <div className="rounded-t-2xl bg-gradient-to-r from-sky-500 to-peacock-500 px-4 py-2">
        <p className="text-[10px] font-semibold uppercase tracking-wider text-white/80">Form</p>
      </div>
